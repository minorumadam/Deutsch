...
$(document).ready(function () {
    ...
    if ($('body').hasClass('material-menu-active')) {
        material_menu_active();
    }
    ...
    setTimeout(function () {
        ...
        $('.circle-slider-ball-left').click(function () {
            $('.circle-slider').trigger('next.owl.carousel');
            return false;
        });
        $('.circle-slider-ball-right').click(function () {
            $('.circle-slider').trigger('prev.owl.carousel');
            return false;
        });
        ...
        $('.next-home-slider, .homepage-slider-ball-left').click(function () {
        ...
        $('.prev-home-slider, .homepage-slider-ball-right').click(function () {
